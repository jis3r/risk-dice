...
<main>
	<div class="container">
		...
		<div class="row">
			<div class="twelve columns">
				<p class="centered">
					Simply input the number of attackers and defenders and click fight to see who will win.
				</p>
			</div>
		</div>
		...
		<div class="row">
			<div class="twelve columns">
				{#each boxes as result}
					<Results round={result.round} message={result.message} fights={result.fights} />
				{/each}
			</div>
		</div>
	</div>
